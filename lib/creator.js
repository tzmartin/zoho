...
Creator.prototype.addRecords = function (ownerName, applicationName, formName, params, callback) {
  params = params || {};

  var endpoint = '/api/' + ownerName + '/json/' + applicationName + '/form/'+formName+'/record/add/';
...
Creator.prototype.editRecords = function (ownerName, applicationName, formName, params, callback) {
  params = params || {};

  var endpoint = '/api/' + ownerName + '/json/' + applicationName + '/form/'+formName+'/record/update/';
...
Creator.prototype.deleteRecords = function (ownerName, applicationName, formName, params, callback) {
  params = params || {};

  var endpoint = '/api/' + ownerName + '/json/' + applicationName + '/form/'+formName+'/record/delete/';
...
Creator.prototype.viewRecordsInView = function (applicationLinkName, viewLinkName, params, callback) {
  ...
  var endpoint = '/api/json/' + applicationLinkName + '/view/'+viewLinkName;
...
Creator.prototype._request = function (method, endpoint, params, callback) {
  ...
  var path = (params.hasOwnProperty('download')) ? endpoint + '?' + qs.stringify(params) : endpoint + '?' + querystring.unescape(qs.stringify(params));
  delete params.path;
